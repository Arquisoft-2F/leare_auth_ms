...
RUN dotnet build "./auth_ms_api.csproj" -c $BUILD_CONFIGURATION -o /app/build

FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./auth_ms_api.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
